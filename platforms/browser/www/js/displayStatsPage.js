	...
	if(position == 0){
		$("#statsPageUpdateGames" + pageId).append(
			"<div class='statsPageUpdateGames'>" +
				"<button id='updateGamesButton" + pageId +"' class='ui-btn updateGamesButton' onclick='updateListOfGames(\"" + Username + "\",\"" + System + "\",\"" + pageId + "\",\"" + Destination + "\",\"" + usersGameList + "\")'>Update Games" +
