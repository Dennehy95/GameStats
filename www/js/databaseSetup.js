...
function onBodyLoad(){
	...
	//useful if you want to pull back distinct rows
	  // easily from the table.
		...
		tx.executeSql( 'CREATE TABLE IF NOT EXISTS Siege(PlayerName varchar(50) NOT NULL, System varchar(30), Active INT, KillsCasual INT, DeathsCasual INT, kdCasual REAL, PlaytimeCasual varchar(10), WinsCasual INT, LossesCasual INT, WinPercentCasual REAL, levelCasual INT, KillsRanked INT, DeathsRanked INT, kdRanked REAL, PlaytimeRanked varchar(10), WinsRanked INT, LossesRanked INT, WinPercentRanked REAL, levelRanked INT, Revives INT, Suicides INT, MeleeKills INT, AccuracyPercent varchar(10), Headshots INT, HeadshotPercent varchar(10), Assists INT,PenetrationKills INT, Time varchar(30))',[],nullHandler,errorHandler);
